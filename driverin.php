						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-lg btn-success btn-block" name="register">New Driver | Register</button>
									
								</div>
							</div>
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-lg btn-success btn-block" name="driverlogin">Driver Log In</button>
